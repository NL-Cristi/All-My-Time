...
go build -ldflags="-s -w -H=windowsgui" -o "$win\MyTimeZones.exe"
.\upx-5.0.1-win64\upx.exe --best "$win\MyTimeZones.exe"

# Build for Linux
$env:GOOS="linux"; $env:GOARCH="amd64"
go build -ldflags="-s -w" -o "$linux\MyTimeZones"
#upx --best "$linux\MyWorkTimes"

# Build for Mac
$env:GOOS="darwin"; $env:GOARCH="amd64"
go build -ldflags="-s -w" -o "$mac\MyTimeZones"
